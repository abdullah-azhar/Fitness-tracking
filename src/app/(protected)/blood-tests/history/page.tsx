...
import { TrendsView } from "@/components/blood-tests/TrendsView";

export default async function BloodTestHistoryPage() {
      ...
      <header className="mb-6 flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400">
            Each marker over time, with its reference range shaded.
          </p>
        </div>
        <Link
          href="/blood-tests/log"
